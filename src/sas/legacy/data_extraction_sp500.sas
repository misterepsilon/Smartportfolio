/* =========================================================
   data_extraction_sp500_v6.sas
   Pipeline d'extraction S&P500 quotidien + mensuel (CRSP).
   Variante de v5 SANS linkage KRIS / sans GVKEY :
     - On ne lit plus mylib.KRIS.
     - Les colonnes GVKEY disparaissent de SP500_CONSTITUENTS_DAILY,
       SP500_DAILY_FULL et SP500_MONTHLY_FULL.
     - Les données ESG (et leur jointure GVKEY) seront extraites
       par un script séparé en aval.
========================================================= */
...
libname mylib  "/home/hecca/aadmberrada/extract_database/data";  /* CONSTITUENTS persistants */
...
/* =========================================================
   4) Persistance des constituents (sans GVKEY) -> MYLIB
   NB : v5 passait par KRIS (PERMNO/PERMCO -> GVKEY).
        v6 saute cette étape ; l'ESG sera traité ailleurs.
========================================================= */
proc sql;
...
/* =========================================================
   --- ÉTAPE 6 : Prix / Retours / Liquidité (CRSP.DSF) ---
...
/* =========================================================
   --- ÉTAPE 7 : Distributions & Splits (CRSP.DSEDIST) ---
...
/* =========================================================
   --- ÉTAPE 8 : Delistings (CRSP.DSEDELIST)
========================================================= */
proc sql;
...
/* =========================================================
   --- ÉTAPE 9 : Indices de marché (CRSP.DSI) : core + extras ---
========================================================= */
proc sql;
